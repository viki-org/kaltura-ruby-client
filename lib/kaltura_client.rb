...
module Kaltura
	...
	class KalturaAssetService < KalturaServiceBase
		...
		def get_playback_context(asset_id, asset_type, context_data_params)
			kparams = {}
			...
			client.queue_service_action_call('asset', 'getPlaybackContext', 'KalturaPlaybackContext', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaAssetFileService < KalturaServiceBase
		...
		def get_context(id, context_type)
			kparams = {}
			client.add_param(kparams, 'id', id)
			client.add_param(kparams, 'contextType', context_type)
		...
		# @return []
		def play_manifest(partner_id, asset_id, asset_type, asset_file_id, context_type, ks=KalturaNotImplemented)
			kparams = {}
			client.add_param(kparams, 'partnerId', partner_id)
			client.add_param(kparams, 'assetId', asset_id)
			client.add_param(kparams, 'assetType', asset_type)
			client.add_param(kparams, 'assetFileId', asset_file_id)
			client.add_param(kparams, 'contextType', context_type)
			client.add_param(kparams, 'ks', ks)
			client.queue_service_action_call('assetfile', 'playManifest', '', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaConfigurationGroupService < KalturaServiceBase
		...
		def add(configuration_group)
			kparams = {}
			client.add_param(kparams, 'configurationGroup', configuration_group)
			client.queue_service_action_call('configurationgroup', 'add', 'KalturaConfigurationGroup', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
		...
		# @return [KalturaConfigurationGroup]
		def update(id, configuration_group)
			kparams = {}
			client.add_param(kparams, 'id', id)
			client.add_param(kparams, 'configurationGroup', configuration_group)
			client.queue_service_action_call('configurationgroup', 'update', 'KalturaConfigurationGroup', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaConfigurationGroupDeviceService < KalturaServiceBase
		...
		# @return [bool]
		def add(configuration_group_device)
			kparams = {}
			client.add_param(kparams, 'configurationGroupDevice', configuration_group_device)
			client.queue_service_action_call('configurationgroupdevice', 'add', 'bool', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaConfigurationGroupTagService < KalturaServiceBase
		...
		def add(configuration_group_tag)
			kparams = {}
			client.add_param(kparams, 'configurationGroupTag', configuration_group_tag)
			client.queue_service_action_call('configurationgrouptag', 'add', 'KalturaConfigurationGroupTag', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
		...
		def delete(tag)
			...
			client.queue_service_action_call('configurationgrouptag', 'delete', 'bool', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
		...
		def list(filter)
			kparams = {}
			client.add_param(kparams, 'filter', filter)
			client.queue_service_action_call('configurationgrouptag', 'list', 'KalturaConfigurationGroupTagListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaConfigurationsService < KalturaServiceBase
		...
		def add(configurations)
			kparams = {}
			client.add_param(kparams, 'configurations', configurations)
			client.queue_service_action_call('configurations', 'add', 'KalturaConfigurations', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
		...
		# @return [file]
		def serve_by_device(application_name, client_version, platform, udid, tag, partner_id=0)
			kparams = {}
			client.add_param(kparams, 'applicationName', application_name)
			client.add_param(kparams, 'clientVersion', client_version)
			client.add_param(kparams, 'platform', platform)
			client.add_param(kparams, 'udid', udid)
			client.add_param(kparams, 'tag', tag)
			client.add_param(kparams, 'partnerId', partner_id)
			client.queue_service_action_call('configurations', 'serveByDevice', 'file', kparams)
			return client.get_serve_url()
		end

		# Update device configuration
		# @return [KalturaConfigurations]
		def update(id, configurations)
			kparams = {}
			client.add_param(kparams, 'id', id)
			client.add_param(kparams, 'configurations', configurations)
			client.queue_service_action_call('configurations', 'update', 'KalturaConfigurations', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaEntitlementService < KalturaServiceBase
		...
		# @return [bool]
		def swap(current_product_id, new_product_id, history)
			kparams = {}
			client.add_param(kparams, 'currentProductId', current_product_id)
			client.add_param(kparams, 'newProductId', new_product_id)
			client.add_param(kparams, 'history', history)
			client.queue_service_action_call('entitlement', 'swap', 'bool', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
		...
		def update(id, entitlement)
			kparams = {}
			client.add_param(kparams, 'id', id)
			client.add_param(kparams, 'entitlement', entitlement)
			client.queue_service_action_call('entitlement', 'update', 'KalturaEntitlement', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaHouseholdService < KalturaServiceBase
		...
		# @return [bool]
		def delete(id=KalturaNotImplemented)
			kparams = {}
			client.add_param(kparams, 'id', id)
	...
	class KalturaHouseholdDeviceService < KalturaServiceBase
		...
		def list(filter=KalturaNotImplemented)
			kparams = {}
			client.add_param(kparams, 'filter', filter)
			client.queue_service_action_call('householddevice', 'list', 'KalturaHouseholdDeviceListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaHouseholdPaymentGatewayService < KalturaServiceBase
		...
		# @return [bool]
		def disable(payment_gateway_id)
			kparams = {}
	...
	class KalturaHouseholdPaymentMethodService < KalturaServiceBase
		...
		def add(household_payment_method)
			kparams = {}
			client.add_param(kparams, 'householdPaymentMethod', household_payment_method)
			client.queue_service_action_call('householdpaymentmethod', 'add', 'KalturaHouseholdPaymentMethod', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaHouseholdUserService < KalturaServiceBase
		...
		def list(filter=KalturaNotImplemented)
			kparams = {}
			client.add_param(kparams, 'filter', filter)
			client.queue_service_action_call('householduser', 'list', 'KalturaHouseholdUserListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaReminderService < KalturaServiceBase
		...
		def add(reminder)
			kparams = {}
			client.add_param(kparams, 'reminder', reminder)
			client.queue_service_action_call('reminder', 'add', 'KalturaReminder', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
		...
		def list(filter, pager=KalturaNotImplemented)
			...
			client.add_param(kparams, 'filter', filter)
			client.add_param(kparams, 'pager', pager)
			client.queue_service_action_call('reminder', 'list', 'KalturaReminderListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaSocialActionService < KalturaServiceBase
		...
		def list(filter, pager=KalturaNotImplemented)
			...
			client.add_param(kparams, 'filter', filter)
			client.add_param(kparams, 'pager', pager)
			client.queue_service_action_call('socialaction', 'list', 'KalturaSocialActionListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaSocialCommentService < KalturaServiceBase
		...
		def list(filter, pager=KalturaNotImplemented)
			...
			client.add_param(kparams, 'filter', filter)
			client.add_param(kparams, 'pager', pager)
			client.queue_service_action_call('socialcomment', 'list', 'KalturaSocialCommentListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaSocialService < KalturaServiceBase
		...
		def get_configuration(type, partner_id=KalturaNotImplemented)
			kparams = {}
			client.add_param(kparams, 'type', type)
			client.add_param(kparams, 'partnerId', partner_id)
		...
		def update_configuration(configuration)
			kparams = {}
			client.add_param(kparams, 'configuration', configuration)
			client.queue_service_action_call('social', 'UpdateConfiguration', 'KalturaSocialConfig', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaSocialFriendActivityService < KalturaServiceBase
		...
		def list(filter=KalturaNotImplemented, pager=KalturaNotImplemented)
			...
			client.add_param(kparams, 'filter', filter)
			client.add_param(kparams, 'pager', pager)
			client.queue_service_action_call('socialfriendactivity', 'list', 'KalturaSocialFriendActivityListResponse', kparams)
			if (client.is_multirequest)
				return nil
			end
			return client.do_queue()
	...
	class KalturaClient < KalturaClientBase
		...
		attr_reader :configuration_group_service
		def configuration_group_service
			if (@configuration_group_service == nil)
				@configuration_group_service = KalturaConfigurationGroupService.new(self)
			end
			return @configuration_group_service
		end
		
		attr_reader :configuration_group_device_service
		def configuration_group_device_service
			if (@configuration_group_device_service == nil)
				@configuration_group_device_service = KalturaConfigurationGroupDeviceService.new(self)
			end
			return @configuration_group_device_service
		end
		
		attr_reader :configuration_group_tag_service
		def configuration_group_tag_service
			if (@configuration_group_tag_service == nil)
				@configuration_group_tag_service = KalturaConfigurationGroupTagService.new(self)
			end
			return @configuration_group_tag_service
		end
		
		attr_reader :configurations_service
		def configurations_service
			if (@configurations_service == nil)
				@configurations_service = KalturaConfigurationsService.new(self)
			end
			return @configurations_service
		end
		
		attr_reader :country_service
		def country_service
			if (@country_service == nil)
				@country_service = KalturaCountryService.new(self)
			end
		...
		attr_reader :device_brand_service
		def device_brand_service
			if (@device_brand_service == nil)
				@device_brand_service = KalturaDeviceBrandService.new(self)
			end
			return @device_brand_service
		end
		
		attr_reader :device_family_service
		def device_family_service
			if (@device_family_service == nil)
				@device_family_service = KalturaDeviceFamilyService.new(self)
			end
			return @device_family_service
		end
		...
		def meta_service
			if (@meta_service == nil)
				@meta_service = KalturaMetaService.new(self)
			end
			return @meta_service
		end
		...
		attr_reader :reminder_service
		def reminder_service
			if (@reminder_service == nil)
				@reminder_service = KalturaReminderService.new(self)
			end
		...
		attr_reader :social_action_service
		def social_action_service
			if (@social_action_service == nil)
				@social_action_service = KalturaSocialActionService.new(self)
			end
			return @social_action_service
		end
		
		attr_reader :social_comment_service
		def social_comment_service
			if (@social_comment_service == nil)
				@social_comment_service = KalturaSocialCommentService.new(self)
			end
			return @social_comment_service
		end
		...
		attr_reader :social_friend_activity_service
		def social_friend_activity_service
			if (@social_friend_activity_service == nil)
				@social_friend_activity_service = KalturaSocialFriendActivityService.new(self)
			end
			return @social_friend_activity_service
		end
		...
		def initialize(client)
			...
			self.api_version = '3.6.1748.28060'
		end
