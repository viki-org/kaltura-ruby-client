...
module Kaltura
	...
	class KalturaMetaListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaMeta')
			end
		end
	...
	class KalturaDeviceBrand < KalturaObjectBase
		...
		attr_accessor :device_familyid

		def id=(val)
			@id = val.to_i
		end
		def device_familyid=(val)
			@device_familyid = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['deviceFamilyid'] != nil
				self.device_familyid = xml_element.elements['deviceFamilyid'].text
			end
		end
	...
	class KalturaDeviceBrandListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaDeviceBrand')
			end
		end
	...
	class KalturaCountryListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaCountry')
			end
		end
	...
	class KalturaOSSAdapterProfileListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaOSSAdapterProfile')
			end
		end
	...
	class KalturaConfigurations < KalturaObjectBase
		...
		attr_accessor :configuration_group_id
		# Application name
		...
		# External push id
		attr_accessor :external_push_id
		# Is force update
		...
		def is_force_update=(val)
			@is_force_update = to_b(val)
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['configurationGroupId'] != nil
				self.configuration_group_id = xml_element.elements['configurationGroupId'].text
			end
			if xml_element.elements['appName'] != nil
				self.app_name = xml_element.elements['appName'].text
			end
			if xml_element.elements['clientVersion'] != nil
				self.client_version = xml_element.elements['clientVersion'].text
			end
			if xml_element.elements['platform'] != nil
				self.platform = xml_element.elements['platform'].text
			end
			if xml_element.elements['externalPushId'] != nil
				self.external_push_id = xml_element.elements['externalPushId'].text
			end
			if xml_element.elements['isForceUpdate'] != nil
				self.is_force_update = xml_element.elements['isForceUpdate'].text
			end
	...
	class KalturaConfigurationsListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaConfigurations')
			end
		end
	...
	class KalturaConfigurationGroupDeviceListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaConfigurationGroupDevice')
			end
		end
	...
	class KalturaConfigurationGroupTagListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaConfigurationGroupTag')
			end
		end
	...
	class KalturaConfigurationGroup < KalturaObjectBase
		...
		attr_accessor :configuration_identifiers
		...
		def number_of_devices=(val)
			@number_of_devices = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['tags'] != nil
				self.tags = KalturaClientBase.object_from_xml(xml_element.elements['tags'], 'KalturaStringValue')
			end
			if xml_element.elements['numberOfDevices'] != nil
				self.number_of_devices = xml_element.elements['numberOfDevices'].text
			end
			if xml_element.elements['configurationIdentifiers'] != nil
				self.configuration_identifiers = KalturaClientBase.object_from_xml(xml_element.elements['configurationIdentifiers'], 'KalturaConfigurationIdentifier')
			end
		end
	...
	class KalturaConfigurationGroupListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaConfigurationGroup')
			end
		end
	...
	class KalturaHouseholdDevice < KalturaObjectBase
		...
		# Device family id
		attr_accessor :device_family_id
		...
		def device_family_id=(val)
			@device_family_id = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['deviceFamilyId'] != nil
				self.device_family_id = xml_element.elements['deviceFamilyId'].text
			end
		end
	...
	class KalturaDeviceFamilyListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaDeviceFamily')
			end
		end
	...
	class KalturaOTTUser < KalturaBaseOTTUser
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['countryId'] != nil
				self.country_id = xml_element.elements['countryId'].text
			end
			...
			if xml_element.elements['suspensionState'] != nil
				self.suspension_state = xml_element.elements['suspensionState'].text
			end
	...
	class KalturaProgramAsset < KalturaAsset
		...
		def linear_asset_id=(val)
			@linear_asset_id = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['linearAssetId'] != nil
				self.linear_asset_id = xml_element.elements['linearAssetId'].text
			end
		end
	...
	class KalturaSocialNetworkComment < KalturaSocialComment
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['likeCounter'] != nil
				self.like_counter = xml_element.elements['likeCounter'].text
			end
			if xml_element.elements['authorImageUrl'] != nil
				self.author_image_url = xml_element.elements['authorImageUrl'].text
			end
		end
	...
	class KalturaFacebookPost < KalturaSocialNetworkComment
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['comments'] != nil
				self.comments = KalturaClientBase.object_from_xml(xml_element.elements['comments'], 'KalturaSocialNetworkComment')
			end
	...
	class KalturaNpvrPremiumService < KalturaPremiumService
		# Quota in minutes
		attr_accessor :quota_in_minutes

		def quota_in_minutes=(val)
			@quota_in_minutes = val.to_i
		end

		def from_xml(xml_element)
			super
			if xml_element.elements['quotaInMinutes'] != nil
				self.quota_in_minutes = xml_element.elements['quotaInMinutes'].text
			end
		end
	...
	class KalturaHouseholdPaymentMethod < KalturaObjectBase
		...
		attr_accessor :payment_method_profile_id
		...
		def payment_method_profile_id=(val)
			@payment_method_profile_id = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['details'] != nil
				self.details = xml_element.elements['details'].text
			end
			if xml_element.elements['isDefault'] != nil
				self.is_default = xml_element.elements['isDefault'].text
			end
			if xml_element.elements['paymentMethodProfileId'] != nil
				self.payment_method_profile_id = xml_element.elements['paymentMethodProfileId'].text
			end
		end
	...
	class KalturaPaymentGatewayProfile < KalturaPaymentGatewayBaseProfile
		...
		attr_accessor :payment_gateway_settings
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['paymentGatewaySettings'] != nil
				self.payment_gateway_settings = KalturaClientBase.object_from_xml(xml_element.elements['paymentGatewaySettings'], 'KalturaStringValue')
			end
			if xml_element.elements['externalIdentifier'] != nil
				self.external_identifier = xml_element.elements['externalIdentifier'].text
			end
	...
	class KalturaHouseholdDeviceListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaHouseholdDevice')
			end
		end
	...
	class KalturaHouseholdUserListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaHouseholdUser')
			end
		end
	...
	class KalturaPushParams < KalturaObjectBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['externalToken'] != nil
				self.external_token = xml_element.elements['externalToken'].text
			end
		end
	...
	class KalturaDeviceReport < KalturaReport
		...
		attr_accessor :udid
		# Push parameters
		attr_accessor :push_parameters
		# Version number
		attr_accessor :version_number
		# Version platform
		attr_accessor :version_platform
		# Version application name
		attr_accessor :version_app_name
		# Last access IP
		attr_accessor :last_access_ip
		# Last access date
		...
		def last_access_date=(val)
			@last_access_date = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['pushParameters'] != nil
				self.push_parameters = KalturaClientBase.object_from_xml(xml_element.elements['pushParameters'], 'KalturaPushParams')
			end
			if xml_element.elements['versionNumber'] != nil
				self.version_number = xml_element.elements['versionNumber'].text
			end
			if xml_element.elements['versionPlatform'] != nil
				self.version_platform = xml_element.elements['versionPlatform'].text
			end
			if xml_element.elements['versionAppName'] != nil
				self.version_app_name = xml_element.elements['versionAppName'].text
			end
			if xml_element.elements['lastAccessIP'] != nil
				self.last_access_ip = xml_element.elements['lastAccessIP'].text
			end
			if xml_element.elements['lastAccessDate'] != nil
				self.last_access_date = xml_element.elements['lastAccessDate'].text
			end
			if xml_element.elements['userAgent'] != nil
				self.user_agent = xml_element.elements['userAgent'].text
			end
			if xml_element.elements['operationSystem'] != nil
				self.operation_system = xml_element.elements['operationSystem'].text
			end
		end
	...
	class KalturaReminderListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaReminder')
			end
		end
	...
	class KalturaCouponsGroup < KalturaObjectBase
		...
		attr_accessor :coupon_group_type
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['couponGroupType'] != nil
				self.coupon_group_type = xml_element.elements['couponGroupType'].text
			end
		end
	...
	class KalturaSocialCommentListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaSocialComment')
			end
		end
	...
	class KalturaSocialAction < KalturaObjectBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['actionType'] != nil
				self.action_type = xml_element.elements['actionType'].text
			end
	...
	class KalturaSocialFriendActivity < KalturaObjectBase
		...
		attr_accessor :user_picture_url
		# The social action
		attr_accessor :social_action


		def from_xml(xml_element)
			super
			if xml_element.elements['userFullName'] != nil
				self.user_full_name = xml_element.elements['userFullName'].text
			end
			if xml_element.elements['userPictureUrl'] != nil
				self.user_picture_url = xml_element.elements['userPictureUrl'].text
			end
			if xml_element.elements['socialAction'] != nil
				self.social_action = KalturaClientBase.object_from_xml(xml_element.elements['socialAction'], 'KalturaSocialAction')
			end
		end
	...
	class KalturaSocialFriendActivityListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaSocialFriendActivity')
			end
		end
	...
	class KalturaSocialActionRate < KalturaSocialAction
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['rate'] != nil
				self.rate = xml_element.elements['rate'].text
			end
		end
	...
	class KalturaSocialActionListResponse < KalturaListResponse
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['objects'] != nil
				self.objects = KalturaClientBase.object_from_xml(xml_element.elements['objects'], 'KalturaSocialAction')
			end
		end
	...
	class KalturaScheduledRecordingProgramFilter < KalturaAssetFilter
		...
		attr_accessor :recording_type_equal
		# Channels to filter by
		attr_accessor :channels_in
		# start date
		attr_accessor :start_date_greater_than_or_null
		# end date
		attr_accessor :end_date_less_than_or_null

		def start_date_greater_than_or_null=(val)
			@start_date_greater_than_or_null = val.to_i
		end
		def end_date_less_than_or_null=(val)
			@end_date_less_than_or_null = val.to_i
		end

		def from_xml(xml_element)
			super
			if xml_element.elements['recordingTypeEqual'] != nil
				self.recording_type_equal = xml_element.elements['recordingTypeEqual'].text
			end
			if xml_element.elements['channelsIn'] != nil
				self.channels_in = xml_element.elements['channelsIn'].text
			end
			if xml_element.elements['startDateGreaterThanOrNull'] != nil
				self.start_date_greater_than_or_null = xml_element.elements['startDateGreaterThanOrNull'].text
			end
			if xml_element.elements['endDateLessThanOrNull'] != nil
				self.end_date_less_than_or_null = xml_element.elements['endDateLessThanOrNull'].text
			end
		end
	...
	class KalturaReminderFilter < KalturaAssetFilter
		# Search assets using dynamic criteria. Provided collection of nested expressions with key, comparison operators, value, and logical conjunction.
		#             Possible keys: any Tag or Meta defined in the system and the following reserved keys: start_date, end_date. 
		#             epg_id, media_id - for specific asset IDs.
		#             geo_block - only valid value is "true": When enabled, only assets that are not restriced to the user by geo-block rules will return.
	...
	class KalturaPlaybackContextOptions < KalturaObjectBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['assetFileIds'] != nil
				self.asset_file_ids = xml_element.elements['assetFileIds'].text
			end
	...
	class KalturaConfigurationGroupDeviceFilter < KalturaFilter
		...
		attr_accessor :configuration_group_id_equal


		def from_xml(xml_element)
			super
			if xml_element.elements['configurationGroupIdEqual'] != nil
				self.configuration_group_id_equal = xml_element.elements['configurationGroupIdEqual'].text
			end
		end
	...
	class KalturaSocialCommentFilter < KalturaFilter
		...
		attr_accessor :social_platform_equal
		# The create date from which to get the comments
		attr_accessor :create_date_greater_than

		def asset_id_equal=(val)
			@asset_id_equal = val.to_i
		end
		def create_date_greater_than=(val)
			@create_date_greater_than = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['socialPlatformEqual'] != nil
				self.social_platform_equal = xml_element.elements['socialPlatformEqual'].text
			end
			if xml_element.elements['createDateGreaterThan'] != nil
				self.create_date_greater_than = xml_element.elements['createDateGreaterThan'].text
			end
		end
	...
	class KalturaNetworkActionStatus < KalturaObjectBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['network'] != nil
				self.network = xml_element.elements['network'].text
			end
		end
	...
	class KalturaUserSocialActionResponse < KalturaObjectBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['failStatus'] != nil
				self.fail_status = KalturaClientBase.object_from_xml(xml_element.elements['failStatus'], 'KalturaNetworkActionStatus')
			end
		end
	...
	class KalturaSocialActionFilter < KalturaFilter
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['actionTypeIn'] != nil
				self.action_type_in = xml_element.elements['actionTypeIn'].text
			end
		end
	...
	class KalturaMetaFilter < KalturaFilter
		...
		attr_accessor :field_name_equal
		# Meta system field name to filter by
		attr_accessor :field_name_not_equal
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['fieldNameEqual'] != nil
				self.field_name_equal = xml_element.elements['fieldNameEqual'].text
			end
			if xml_element.elements['fieldNameNotEqual'] != nil
				self.field_name_not_equal = xml_element.elements['fieldNameNotEqual'].text
			end
	...
	class KalturaDeviceReportFilter < KalturaReportFilter
		...
		attr_accessor :last_access_date_greater_than_or_equal

		def last_access_date_greater_than_or_equal=(val)
			@last_access_date_greater_than_or_equal = val.to_i
		end

		def from_xml(xml_element)
			super
			if xml_element.elements['lastAccessDateGreaterThanOrEqual'] != nil
				self.last_access_date_greater_than_or_equal = xml_element.elements['lastAccessDateGreaterThanOrEqual'].text
			end
		end
	...
	class KalturaPaymentGatewayConfiguration < KalturaObjectBase
		...
		attr_accessor :payment_gateway_configuration


		def from_xml(xml_element)
			super
			if xml_element.elements['paymentGatewayConfiguration'] != nil
				self.payment_gateway_configuration = KalturaClientBase.object_from_xml(xml_element.elements['paymentGatewayConfiguration'], 'KalturaKeyValue')
			end
		end
	...
	class KalturaNotificationsPartnerSettings < KalturaObjectBase
		...
		attr_accessor :reminder_offset_sec
		# Push adapter URL
		attr_accessor :push_adapter_url
		...
		def reminder_enabled=(val)
			@reminder_enabled = to_b(val)
		end
		def reminder_offset_sec=(val)
			@reminder_offset_sec = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['reminderEnabled'] != nil
				self.reminder_enabled = xml_element.elements['reminderEnabled'].text
			end
			if xml_element.elements['reminderOffsetSec'] != nil
				self.reminder_offset_sec = xml_element.elements['reminderOffsetSec'].text
			end
			if xml_element.elements['pushAdapterUrl'] != nil
				self.push_adapter_url = xml_element.elements['pushAdapterUrl'].text
			end
		end
	...
	class KalturaTimeShiftedTvPartnerSettings < KalturaObjectBase
		...
		attr_accessor :cleanup_notice_period
		...
		def cleanup_notice_period=(val)
			@cleanup_notice_period = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['cleanupNoticePeriod'] != nil
				self.cleanup_notice_period = xml_element.elements['cleanupNoticePeriod'].text
			end
	...
	class KalturaAssetHistoryFilter < KalturaFilter
		...
		attr_accessor :days_less_than_or_equal

		def days_less_than_or_equal=(val)
			@days_less_than_or_equal = val.to_i
		end
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['daysLessThanOrEqual'] != nil
				self.days_less_than_or_equal = xml_element.elements['daysLessThanOrEqual'].text
			end
		end
	...
	class KalturaHouseholdDeviceFilter < KalturaFilter
		# The identifier of the household
		attr_accessor :household_id_equal
		# Device family Ids
		attr_accessor :device_family_id_in

		def household_id_equal=(val)
			@household_id_equal = val.to_i
		end

		def from_xml(xml_element)
			super
			if xml_element.elements['householdIdEqual'] != nil
				self.household_id_equal = xml_element.elements['householdIdEqual'].text
			end
			if xml_element.elements['deviceFamilyIdIn'] != nil
				self.device_family_id_in = xml_element.elements['deviceFamilyIdIn'].text
			end
		end
	...
	class KalturaActionPermissionItem < KalturaObjectBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['actionPrivacy'] != nil
				self.action_privacy = xml_element.elements['actionPrivacy'].text
			end
	...
	class KalturaSocialUserConfig < KalturaSocialConfig
		# List of action permission items
		attr_accessor :action_permission_items


		def from_xml(xml_element)
			super
			if xml_element.elements['actionPermissionItems'] != nil
				self.action_permission_items = KalturaClientBase.object_from_xml(xml_element.elements['actionPermissionItems'], 'KalturaActionPermissionItem')
			end
		end
	...
	class KalturaPurchase < KalturaPurchaseBase
		...
		def from_xml(xml_element)
			...
			if xml_element.elements['adapterData'] != nil
				self.adapter_data = xml_element.elements['adapterData'].text
			end
		end
	...
	class KalturaOTTUserFilter < KalturaFilter
		# Username
		attr_accessor :username_equal
		# User external identifier
		attr_accessor :external_id_equal
		...
		def from_xml(xml_element)
			super
			if xml_element.elements['usernameEqual'] != nil
				self.username_equal = xml_element.elements['usernameEqual'].text
			end
			if xml_element.elements['externalIdEqual'] != nil
				self.external_id_equal = xml_element.elements['externalIdEqual'].text
			end
			if xml_element.elements['idIn'] != nil
				self.id_in = xml_element.elements['idIn'].text
			end
